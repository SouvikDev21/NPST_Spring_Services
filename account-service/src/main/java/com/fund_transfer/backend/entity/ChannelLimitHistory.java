...
@Entity
@Table(
        name = "channel_limit_history",
        indexes = {
                @Index(name = "idx_chan_hist_channel", columnList = "channel"),
                @Index(name = "idx_chan_hist_time", columnList = "timestamp")
        }
)
...
@NoArgsConstructor
@AllArgsConstructor
public class ChannelLimitHistory {
