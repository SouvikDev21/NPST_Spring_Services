...
import com.account_service.backend.common.constants.StatementConstants;
import com.account_service.backend.common.exception.ResourceNotFoundException;
import com.account_service.backend.common.exception.StatementException;
...
import com.account_service.backend.repository.StatementAuditRepository;
...
public class StatementServiceImpl implements StatementService {
    ...
    public SearchResponse searchStatements(SearchRequest request) {
    ...
    @Override
    @Transactional
    public DownloadResponse downloadStatement(DownloadRequest request) {
        String accountNumber = request.getAccountNumber();
        LocalDate fromDate = request.getFromDate() != null ? request.getFromDate() : LocalDate.now().minusDays(30);
        LocalDate toDate = request.getToDate() != null ? request.getToDate() : LocalDate.now();
    ...
    @Override
    @Transactional
    public EmailResponse emailStatement(EmailRequest request) {
        String accountNumber = request.getAccountNumber();
